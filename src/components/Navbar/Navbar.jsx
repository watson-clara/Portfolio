    ...
    <nav className={`${styles.navbar} ${isScrolled ? styles.scrolled : ''} ${isLoaded ? styles.loaded : ''}`}>
      <div className={styles.container}>
        <div className={styles.logo} onClick={scrollToTop} style={{ cursor: 'pointer' }}>
          <img src="/src/assets/clara1.svg" alt="C" className={styles.nameLetter} style={{ '--delay': '0.1s' }} />
          <img src="/src/assets/clara2.svg" alt="L" className={styles.nameLetter} style={{ '--delay': '0.2s' }} />
          <img src="/src/assets/clara3.svg" alt="A" className={styles.nameLetter} style={{ '--delay': '0.3s' }} />
          <img src="/src/assets/clara4.svg" alt="R" className={styles.nameLetter} style={{ '--delay': '0.4s' }} />
          <img src="/src/assets/clara5.svg" alt="A" className={styles.nameLetter} style={{ '--delay': '0.5s' }} />
        </div>
